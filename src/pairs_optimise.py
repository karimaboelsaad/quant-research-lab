...
def evaluate_pair_period(df, start_position, end_position, lookback, entry_threshold, exit_threshold, cost_rate):
...
def evaluate_pair_parameters_on_period(df, start_position, end_position, lookbacks, entry_thresholds, exit_thresholds, cost_rate):
    results=[]
